...
- [1. 它是什么](#1-它是什么)
- [2. 基本示例](#2-基本示例)
- [3. CAS 的核心特点](#3-cas-的核心特点)
  - [3.1 原子性](#31-原子性)
  - [3.2 无锁](#32-无锁)
  - [3.3 乐观并发](#33-乐观并发)
- [4. CAS 自旋流程](#4-cas-自旋流程)
- [5. Java 中哪些类使用 CAS](#5-java-中哪些类使用-cas)
- [6. CAS 底层依赖什么](#6-cas-底层依赖什么)
- [7. CAS 和 volatile 的关系](#7-cas-和-volatile-的关系)
- [8. CAS 的优点](#8-cas-的优点)
- [9. CAS 的缺点](#9-cas-的缺点)
  - [9.1 ABA 问题](#91-aba-问题)
  - [9.2 自旋开销](#92-自旋开销)
  - [9.3 只能保证单个变量的原子操作](#93-只能保证单个变量的原子操作)
- [10. ABA 问题示例](#10-aba-问题示例)
- [11. CAS 和 synchronized 的区别](#11-cas-和-synchronized-的区别)
  - [11.1 CAS](#111-cas)
  - [11.2 synchronized](#112-synchronized)
- [12. AtomicInteger 和 LongAdder 的区别](#12-atomicinteger-和-longadder-的区别)
- [13. 使用注意事项](#13-使用注意事项)
- [14. 面试常问](#14-面试常问)
  - [14.1 CAS 是什么？](#141-cas-是什么)
  - [14.2 CAS 为什么是乐观锁？](#142-cas-为什么是乐观锁)
  - [14.3 CAS 有哪些问题？](#143-cas-有哪些问题)
  - [14.4 ABA 问题如何解决？](#144-aba-问题如何解决)
  - [14.5 CAS 和 volatile 有什么区别？](#145-cas-和-volatile-有什么区别)
  - [14.6 CAS 和 synchronized 怎么选？](#146-cas-和-synchronized-怎么选)
- [15. 一句话总结](#15-一句话总结)
- [16. 参考来源](#16-参考来源)
- [17. 当前项目使用情况](#17-当前项目使用情况)
  - [17.1 使用分布](#171-使用分布)
  - [17.2 代表代码位置](#172-代表代码位置)
  - [17.3 项目里用到的知识点](#173-项目里用到的知识点)
  - [17.4 当前项目未明显使用的点](#174-当前项目未明显使用的点)
  - [17.5 复习时结合项目记忆](#175-复习时结合项目记忆)
- [18. 复习与面试讲解流程图](#18-复习与面试讲解流程图)
  - [18.1 复习思路流程图](#181-复习思路流程图)
  - [18.2 面试讲解思路流程图](#182-面试讲解思路流程图)
