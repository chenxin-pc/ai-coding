...
- [1. 它是什么](#1-它是什么)
- [2. 核心创建方式](#2-核心创建方式)
  - [2.1 runAsync：没有返回值](#21-runasync没有返回值)
  - [2.2 supplyAsync：有返回值](#22-supplyasync有返回值)
  - [2.3 指定线程池](#23-指定线程池)
- [3. 常见回调方法](#3-常见回调方法)
  - [3.1 thenApply：转换结果](#31-thenapply转换结果)
  - [3.2 thenAccept：消费结果](#32-thenaccept消费结果)
  - [3.3 thenRun：继续执行动作](#33-thenrun继续执行动作)
- [4. Async 后缀的区别](#4-async-后缀的区别)
- [5. 多任务组合](#5-多任务组合)
  - [5.1 thenCompose：依赖上一个任务，再发起新异步任务](#51-thencompose依赖上一个任务再发起新异步任务)
  - [5.2 thenCombine：两个任务都完成后合并结果](#52-thencombine两个任务都完成后合并结果)
  - [5.3 allOf：等待所有任务完成](#53-allof等待所有任务完成)
  - [5.4 anyOf：任意一个任务完成即可](#54-anyof任意一个任务完成即可)
- [6. 异常处理](#6-异常处理)
  - [6.1 exceptionally：异常兜底](#61-exceptionally异常兜底)
  - [6.2 handle：成功或失败都会执行](#62-handle成功或失败都会执行)
  - [6.3 whenComplete：观察结果，不改变返回值](#63-whencomplete观察结果不改变返回值)
- [7. get 和 join 的区别](#7-get-和-join-的区别)
  - [get](#get)
  - [join](#join)
- [8. 超时控制](#8-超时控制)
- [9. 常见使用场景](#9-常见使用场景)
  - [9.1 聚合多个远程接口](#91-聚合多个远程接口)
  - [9.2 异步执行非核心逻辑](#92-异步执行非核心逻辑)
  - [9.3 串行依赖任务](#93-串行依赖任务)
- [10. 使用注意事项](#10-使用注意事项)
  - [10.1 不要滥用默认线程池](#101-不要滥用默认线程池)
  - [10.2 注意线程池隔离](#102-注意线程池隔离)
  - [10.3 注意异常吞掉问题](#103-注意异常吞掉问题)
  - [10.4 注意上下文丢失](#104-注意上下文丢失)
  - [10.5 注意事务边界](#105-注意事务边界)
- [11. 面试常问](#11-面试常问)
  - [11.1 CompletableFuture 相比 Future 的优势是什么？](#111-completablefuture-相比-future-的优势是什么)
  - [11.2 thenApply 和 thenCompose 的区别？](#112-thenapply-和-thencompose-的区别)
  - [11.3 thenCombine 和 allOf 的区别？](#113-thencombine-和-allof-的区别)
  - [11.4 exceptionally、handle、whenComplete 的区别？](#114-exceptionallyhandlewhencomplete-的区别)
  - [11.5 为什么生产环境建议指定线程池？](#115-为什么生产环境建议指定线程池)
- [12. 一句话总结](#12-一句话总结)
- [13. 参考来源](#13-参考来源)
