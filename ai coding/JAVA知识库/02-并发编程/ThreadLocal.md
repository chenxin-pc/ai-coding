...
- [1. 它是什么](#1-它是什么)
- [2. 基本用法](#2-基本用法)
- [3. ThreadLocal 解决什么问题](#3-threadlocal-解决什么问题)
  - [3.1 线程隔离](#31-线程隔离)
  - [3.2 在线程调用链中传递上下文](#32-在线程调用链中传递上下文)
- [4. 底层原理](#4-底层原理)
- [5. 为什么会内存泄漏](#5-为什么会内存泄漏)
- [6. 为什么必须 remove](#6-为什么必须-remove)
- [7. 在线程池中的坑](#7-在线程池中的坑)
- [8. InheritableThreadLocal](#8-inheritablethreadlocal)
- [9. 异步场景中的上下文传递](#9-异步场景中的上下文传递)
- [10. 常见使用场景](#10-常见使用场景)
  - [10.1 保存请求上下文](#101-保存请求上下文)
  - [10.2 日志链路追踪](#102-日志链路追踪)
  - [10.3 动态数据源](#103-动态数据源)
- [11. ThreadLocal 和 synchronized 的区别](#11-threadlocal-和-synchronized-的区别)
- [12. 面试常问](#12-面试常问)
  - [12.1 ThreadLocal 的作用是什么？](#121-threadlocal-的作用是什么)
  - [12.2 ThreadLocal 的底层原理是什么？](#122-threadlocal-的底层原理是什么)
  - [12.3 ThreadLocal 为什么会内存泄漏？](#123-threadlocal-为什么会内存泄漏)
  - [12.4 如何避免 ThreadLocal 内存泄漏？](#124-如何避免-threadlocal-内存泄漏)
  - [12.5 ThreadLocal 能不能解决所有线程安全问题？](#125-threadlocal-能不能解决所有线程安全问题)
  - [12.6 InheritableThreadLocal 在线程池中有什么问题？](#126-inheritablethreadlocal-在线程池中有什么问题)
- [13. 一句话总结](#13-一句话总结)
- [14. 参考来源](#14-参考来源)
- [15. 当前项目使用情况](#15-当前项目使用情况)
  - [15.1 使用分布](#151-使用分布)
  - [15.2 代表代码位置](#152-代表代码位置)
  - [15.3 项目里用到的知识点](#153-项目里用到的知识点)
  - [15.4 复习时结合项目记忆](#154-复习时结合项目记忆)
