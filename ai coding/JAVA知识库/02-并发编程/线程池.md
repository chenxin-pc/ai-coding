...
- [1. 它是什么](#1-它是什么)
- [2. 为什么需要线程池](#2-为什么需要线程池)
- [3. 核心接口和类](#3-核心接口和类)
  - [3.1 Executor](#31-executor)
  - [3.2 ExecutorService](#32-executorservice)
  - [3.3 ThreadPoolExecutor](#33-threadpoolexecutor)
- [4. 七大核心参数](#4-七大核心参数)
  - [4.1 corePoolSize](#41-corepoolsize)
  - [4.2 maximumPoolSize](#42-maximumpoolsize)
  - [4.3 keepAliveTime](#43-keepalivetime)
  - [4.4 unit](#44-unit)
  - [4.5 workQueue](#45-workqueue)
  - [4.6 threadFactory](#46-threadfactory)
  - [4.7 handler](#47-handler)
- [5. 任务执行流程](#5-任务执行流程)
- [6. 常见拒绝策略](#6-常见拒绝策略)
  - [6.1 AbortPolicy](#61-abortpolicy)
  - [6.2 CallerRunsPolicy](#62-callerrunspolicy)
  - [6.3 DiscardPolicy](#63-discardpolicy)
  - [6.4 DiscardOldestPolicy](#64-discardoldestpolicy)
- [7. execute 和 submit 的区别](#7-execute-和-submit-的区别)
  - [7.1 execute](#71-execute)
  - [7.2 submit](#72-submit)
- [8. shutdown 和 shutdownNow](#8-shutdown-和-shutdownnow)
  - [8.1 shutdown](#81-shutdown)
  - [8.2 shutdownNow](#82-shutdownnow)
- [9. 线程池状态](#9-线程池状态)
- [10. Executors 快捷方法的注意点](#10-executors-快捷方法的注意点)
- [11. 线程数如何设置](#11-线程数如何设置)
  - [11.1 CPU 密集型任务](#111-cpu-密集型任务)
  - [11.2 IO 密集型任务](#112-io-密集型任务)
- [12. 生产使用建议](#12-生产使用建议)
- [13. 面试常问](#13-面试常问)
  - [13.1 线程池的核心参数有哪些？](#131-线程池的核心参数有哪些)
  - [13.2 线程池提交任务后的执行流程是什么？](#132-线程池提交任务后的执行流程是什么)
  - [13.3 为什么不建议直接使用 Executors？](#133-为什么不建议直接使用-executors)
  - [13.4 execute 和 submit 有什么区别？](#134-execute-和-submit-有什么区别)
  - [13.5 线程池如何优雅关闭？](#135-线程池如何优雅关闭)
- [14. 一句话总结](#14-一句话总结)
- [15. 参考来源](#15-参考来源)
- [16. 当前项目使用情况](#16-当前项目使用情况)
  - [16.1 使用分布](#161-使用分布)
  - [16.2 代表代码位置](#162-代表代码位置)
  - [16.3 项目里用到的知识点](#163-项目里用到的知识点)
  - [16.4 复习时结合项目记忆](#164-复习时结合项目记忆)
