...
- [1. 它是什么](#1-它是什么)
- [2. 为什么需要代理](#2-为什么需要代理)
- [3. Java 中常见代理类型](#3-java-中常见代理类型)
- [4. 静态代理](#4-静态代理)
- [5. JDK 动态代理](#5-jdk-动态代理)
- [6. CGLIB 动态代理](#6-cglib-动态代理)
- [7. JDK 动态代理和 CGLIB 对比](#7-jdk-动态代理和-cglib-对比)
- [8. Spring AOP 和代理](#8-spring-aop-和代理)
- [9. `@Transactional` 自调用为什么会失效](#9-transactional-自调用为什么会失效)
- [10. 实际工作中的常见代理](#10-实际工作中的常见代理)
  - [10.1 事务代理](#101-事务代理)
  - [10.2 缓存代理](#102-缓存代理)
  - [10.3 Feign Client 代理](#103-feign-client-代理)
  - [10.4 MyBatis Mapper 代理](#104-mybatis-mapper-代理)
  - [10.5 AOP 切面代理](#105-aop-切面代理)
- [11. 当前项目使用情况](#11-当前项目使用情况)
  - [11.1 总体结论](#111-总体结论)
  - [11.2 Spring AOP：自定义切面](#112-spring-aop自定义切面)
  - [11.3 Spring 事务代理](#113-spring-事务代理)
  - [11.4 Spring Cache 代理](#114-spring-cache-代理)
  - [11.5 Feign Client 代理](#115-feign-client-代理)
  - [11.6 MyBatis Mapper 代理](#116-mybatis-mapper-代理)
  - [11.7 BeanPostProcessor 处理代理 Bean](#117-beanpostprocessor-处理代理-bean)
  - [11.8 项目复习重点](#118-项目复习重点)
- [12. 复习思路流程图](#12-复习思路流程图)
- [13. 面试讲解思路流程图](#13-面试讲解思路流程图)
- [14. 一句话总结](#14-一句话总结)
- [15. 参考来源](#15-参考来源)
