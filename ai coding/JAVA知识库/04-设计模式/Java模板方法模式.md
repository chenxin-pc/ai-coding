...
- [2. 标准角色](#2-标准角色)
- [3. 基础示例](#3-基础示例)
- [4. Hook 钩子方法](#4-hook-钩子方法)
- [5. 为什么不每个类自己写流程](#5-为什么不每个类自己写流程)
- [6. 和策略模式的区别](#6-和策略模式的区别)
- [7. 和责任链模式的区别](#7-和责任链模式的区别)
- [8. 当前项目中的使用匹配](#8-当前项目中的使用匹配)
  - [8.1 ka-order：订单下单执行链](#81-ka-order订单下单执行链)
  - [8.2 ka-order：保存订单前后处理的默认方法模板](#82-ka-order保存订单前后处理的默认方法模板)
  - [8.3 ka-solution：电子签公共流程](#83-ka-solution电子签公共流程)
  - [8.4 openapi-router：第三方接口默认调用流程](#84-openapi-router第三方接口默认调用流程)
  - [8.5 ka-monitor：工单告警统一异常包装](#85-ka-monitor工单告警统一异常包装)
  - [8.6 Spring Template 类在项目中的使用](#86-spring-template-类在项目中的使用)
  - [8.7 容易误判的点](#87-容易误判的点)
- [9. 实际工作总结](#9-实际工作总结)
- [10. 复习的思路](#10-复习的思路)
- [11. 面试讲解思路](#11-面试讲解思路)
- [12. 面试常见追问](#12-面试常见追问)
  - [12.1 模板方法为什么建议加 final？](#121-模板方法为什么建议加-final)
  - [12.2 Hook 和抽象方法有什么区别？](#122-hook-和抽象方法有什么区别)
  - [12.3 模板方法是不是一定要用抽象类？](#123-模板方法是不是一定要用抽象类)
  - [12.4 模板方法和策略模式怎么选？](#124-模板方法和策略模式怎么选)
  - [12.5 模板方法和责任链怎么组合？](#125-模板方法和责任链怎么组合)
- [13. 使用建议](#13-使用建议)
- [14. 来源和参考](#14-来源和参考)
