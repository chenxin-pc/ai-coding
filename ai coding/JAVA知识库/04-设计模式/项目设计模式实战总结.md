...
- [1. 这篇笔记解决什么问题](#1-这篇笔记解决什么问题)
- [2. 总体模式清单](#2-总体模式清单)
  - [2.1 容易误判的类名](#21-容易误判的类名)
- [3. 各项目模式覆盖](#3-各项目模式覆盖)
- [4. 下单业务：最完整的模式组合](#4-下单业务最完整的模式组合)
  - [4.1 核心源码](#41-核心源码)
  - [4.2 模式角色映射](#42-模式角色映射)
  - [4.3 启动阶段](#43-启动阶段)
  - [4.4 运行流程](#44-运行流程)
  - [4.5 为什么要组合这些模式](#45-为什么要组合这些模式)
  - [4.6 组合后的优点](#46-组合后的优点)
- [5. 路由与回单推送：观察者 + 策略 + 模板 + 重试](#5-路由与回单推送观察者-策略-模板-重试)
  - [5.1 核心源码](#51-核心源码)
  - [5.2 角色映射](#52-角色映射)
  - [5.3 调用流程](#53-调用流程)
  - [5.4 组合优点](#54-组合优点)
- [6. 开放平台转发：责任链 + 适配器 + 模板 + 策略 + 装饰器](#6-开放平台转发责任链-适配器-模板-策略-装饰器)
  - [6.1 核心源码](#61-核心源码)
  - [6.2 模式角色](#62-模式角色)
  - [6.3 调用流程](#63-调用流程)
  - [6.4 组合优点](#64-组合优点)
- [7. 公共重试：观察者 + 工厂 + 策略 + Retry](#7-公共重试观察者-工厂-策略-retry)
  - [7.1 角色映射](#71-角色映射)
  - [7.2 调用流程](#72-调用流程)
  - [7.3 组合优点](#73-组合优点)
- [8. 运单更新：有序责任链 + 节点模板](#8-运单更新有序责任链-节点模板)
  - [8.1 核心角色](#81-核心角色)
  - [8.2 流程](#82-流程)
- [9. 监控工单：工厂 + 策略 + 异常模板](#9-监控工单工厂-策略-异常模板)
- [10. 其他模式证据](#10-其他模式证据)
  - [10.1 观察者模式](#101-观察者模式)
  - [10.2 AOP 代理模式](#102-aop-代理模式)
  - [10.3 单例模式](#103-单例模式)
  - [10.4 Builder 模式](#104-builder-模式)
  - [10.5 Operator 和回调扩展点](#105-operator-和回调扩展点)
- [11. 模式组合的统一理解](#11-模式组合的统一理解)
  - [11.1 最重要的组合原则](#111-最重要的组合原则)
- [12. 当前实现的风险与改进方向](#12-当前实现的风险与改进方向)
  - [12.1 字符串匹配策略 Bean](#121-字符串匹配策略-bean)
  - [12.2 责任链顺序隐式](#122-责任链顺序隐式)
  - [12.3 插件自动注入的副作用](#123-插件自动注入的副作用)
  - [12.4 抽象基类过大](#124-抽象基类过大)
  - [12.5 Adapter 类数量膨胀](#125-adapter-类数量膨胀)
- [13. 复习流程](#13-复习流程)
  - [13.1 推荐复习顺序](#131-推荐复习顺序)
  - [13.2 每个业务必须回答的问题](#132-每个业务必须回答的问题)
- [14. 面试讲解流程](#14-面试讲解流程)
  - [14.1 三分钟下单案例话术](#141-三分钟下单案例话术)
  - [14.2 面试时不要这样讲](#142-面试时不要这样讲)
- [15. 一页速记](#15-一页速记)
